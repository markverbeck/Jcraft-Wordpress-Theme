...
<a href="/J-Craft/cart" style="color: black;" class="hvr-grow cart_link"><?php echo do_shortcode('[wp_compact_cart]'); ?></a>
    ...
    <div class="col-md-12 col-lg-8 animated fadeInRight">
      <div class="row text-center new_product_div">
        <div class="col-lg-12">
          <h2 class="new_product_title">Search Results</h2>
        </div>
    ...
    <?php endwhile; else: ?>
      <h2 class="no_results text-center">Sorry we couldn't find anything matching your search....</h2>
